        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommunityPosts_Alerts_AlertId",
                        column: x => x.AlertId,
                        principalTable: "Alerts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_CommunityPosts_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Alerts_TenantId_DeviceId_Type_CreatedAt",
                table: "Alerts",
                columns: new[] { "TenantId", "DeviceId", "Type", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_CommunityPosts_AlertId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunityPosts_TenantId",
                table: "CommunityPosts",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_TenantId_DeviceId",
                table: "Devices",
